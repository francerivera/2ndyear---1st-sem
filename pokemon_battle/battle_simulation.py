...
def simulate_battles():
    ...
    while player1_battle_pokemon and player2_battle_pokemon:
        ...
        winner_info = battle(p1, p2, player1_currency, player2_currency, round_number, run_command_used,
                             player1_battle_pokemon, player2_battle_pokemon, player1_wins, player2_wins)
        ...
        # Display match history every 3 rounds
        if round_number % 3 == 0:
            print("\n=== Match History ===")
            display_history()
...
def display_final_statistics(player1_battle_pokemon, player2_battle_pokemon, player1_currency, player2_currency,
    ...
    # Display remaining Pokémon for both players
    ...
    # Determine the winner and display the message
    if player1_battle_pokemon:
        print("\nPlayer 1 wins the battle!")
    elif player2_battle_pokemon:
        print("\nPlayer 2 wins the battle!")
    else:
        print("\nThe battle ended in a draw!")

    # Display final health totals and currency
